...
# Video inference
cap = cv2.VideoCapture('Segformer/img and vdos/vid1.mp4')
fourcc = cv2.VideoWriter_fourcc(*'XVID')
# out = cv2.VideoWriter('output_video.avi', fourcc, 30.0, (int(cap.get(3)), int(cap.get(4))))
out = cv2.VideoWriter('Segformer/outputs/output_vid1.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30.0, (int(cap.get(3)), int(cap.get(4))))
